      ...
      <div class="card-header border-transparent">
        <h3 class="card-title">
          <font style="vertical-align: inherit;">
            <font style="vertical-align: inherit;">Client Non Payé</font>
          </font>
        </h3>
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table id="table2" class="table table-hover">
                  ...
                  <tbody>
                    <tr v-for="client in clientsNonpaye" :key="client.operation_id">
                      <td>{{client.nom}}</td>
                      <td>{{client.prenom}}</td>
                      <td>{{client.tel}}</td>
...
,
  ...
  methods: {
    ...
    getResults() {
      this.form.post("api/clientnonpaye").then(response => {
        this.clientsNonpaye = response.data;
        console.log(this.clientsNonpaye);
      });
    }
  }
};
